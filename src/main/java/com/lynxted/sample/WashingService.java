...
class WashingService {
    ...
    Collection<LaundryElement> washWool(WashingMachine washingMachine, Laundry laundry, Integer spinSpeed, Integer temperature) {
        List<LaundryElement> laundryToBeDone = maximumLoadFrom(laundry);
    ...
    private List<LaundryElement> maximumLoadFrom(Laundry laundry) {
